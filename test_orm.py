...
def test_get_hero(db, Hero):
    ...
    hero_1 = save_obj(db, Hero, name="Dead pond", secret_name="Dive Wilson")
    hero_2 = save_obj(db, Hero, name="Spider-Boy", secret_name="Pedro Parquetry", age=1)
    ...
    assert hero.secret_name == "Pedro Parquetry"